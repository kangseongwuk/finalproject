    ...
    <div class="row">
      <div class="col-lg-12">
       <div class="section-title text-center">
          <h2 class="text-color">FAQ 수정하기</h2>
          </div>
      </div>
    </div>

	<div class="board_view">
		<form:form action="${root }faq/faqModify_pro" method="post" modelAttribute="fbModifyBean"
		enctype="multipart/form-data">
		<form:hidden path="fb_no" value="${fbModifyBean.fb_no}"/>
		
		<table>
		<tr>
		 <th class="th-writetitle">질문</th>
		 <th class="th-border">
			<form:input class="write-width" path="fb_contentsQ" value="${fbModifyBean.fb_contentsQ}"/>
		...
		<tr>
		 ...
		 <th class="th-border">
			<form:textarea class="write-width"  path="fb_contentsA" rows="10" style="resize:none" value="${fbModifyBean.fb_contentsA}"></form:textarea>
