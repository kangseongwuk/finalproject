			...
			<div class="col-sm-12 text-center">
				<ul class="list-inline text-center">
					...
					<li class="list-inline-item"><a class="d-inline-block p-2"
					 ...
					 <li class="list-inline-item"><a class="d-inline-block p-2" href="${root}member/mypage_siteAsk?m_memberNo=${sessionScope.loginAcademyMemberBean.a_memberNo}"><h4>내 문의사항</h4></a></li>
				</ul>
			</div>
		</div>
	</div>
