...
<section class="section bg-gray">
  <div class="container">
	...
	<form:input class="search-txt btn-round"  path="searchKeyword" placeholder="검색어를 입력해 주세요" value = "" />
...
<!-- /table -->
		<%-- <button class="search-btn btn-round btn-color" href="${root}serviceBoard/noticeBoardWrite" value="글쓰기"/> --%>
		
		<br><br>
		<div align="right">
		<button class="search-btn btn-round btn-color" onclick="location.href='${root }serviceBoard/noticeBoardWrite'">글쓰기</button>
		</div>
		<div>
			  <nav>
