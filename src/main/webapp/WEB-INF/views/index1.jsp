        ...
        <div class="collapse navbar-collapse" id="navigation">
          <ul class="navbar-nav ml-auto text-center">
            ...
            <li class="nav-item @@about">
              <a class="nav-link" href="gBoardList_temp">종합</a>
            </li>
...
<section class="section bg-primary">
  <div class="container">
    <div class="row">
      <div class="col-12 text-center">
        <h2 class="section-title text-white">SKYCASTLE을 사용해야 하는 이유 !</h2>
        <a href="contact.html" class="btn btn-light">신청하기</a>
      </div>
    </div>
  </div>
</section>
...
<section class="section">
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-12">
        <h2 class="section-title">이달의 강사</h2>
      </div>
      <!-- teacher -->
